...
#Scale 6 Decoded
# _C.SERVER.TRAIN_DATA = '/localhome/gba50/Finalize/dataset/Pavlov/cr/scale10/train'
# _C.SERVER.VAL_DATA = '/localhome/gba50/Finalize/dataset/Pavlov/cr/scale10/val'
_C.SERVER.TEST_DATA = 'scale8'
_C.SERVER.OUTPUT = 'output'  
